...
#define UART0_CTL               (*((volatile uint32_t *) 0x4000C030)) // UART Control
#define UART0_IBRD              (*((volatile uint32_t *) 0x4000C024)) // UART Integer Baud-Rate Divisor
#define UART0_FBRD              (*((volatile uint32_t *) 0x4000C028)) // UART Fractional Baud-Rate Divisor  
#define UART0_LCRH              (*((volatile uint32_t *) 0x4000C02C)) // UART Line Control  
#define UART0_CC                (*((volatile uint32_t *) 0x4000CFC8)) // UART Clock Configuration   
#define UART0_DR                (*((volatile uint32_t *) 0x4000C000)) // UART Data   
#define UART0_FR                (*((volatile uint32_t *) 0x4000C018)) // UART Flag  
