...
// UART
#define RCGCUART                (*((volatile uint32_t *) 0x400FE618)) // define UART regrister    
#define GPIOAFSEL_A             (*((volatile uint32_t *) 0x40058420)) // GPIO Alternate Function Selection
#define GPIOPCTL_A              (*((volatile uint32_t *) 0x4005852C)) // GPIO Port control    
#define GPIODEN_A               (*((volatile uint32_t *) 0x4005851C)) // GPIO Digital Enable
#define UART2_CTL               (*((volatile uint32_t *) 0x4000C030)) // UART Control
#define UART2_IBRD              (*((volatile uint32_t *) 0x4000C024)) // UART Integer Baud-Rate Divisor
#define UART2_FBRD              (*((volatile uint32_t *) 0x4000C028)) // UART Fractional Baud-Rate Divisor  
#define UART2_LCRH              (*((volatile uint32_t *) 0x4000C02C)) // UART Line Control  
#define UART2_CC                (*((volatile uint32_t *) 0x4000CFC8)) // UART Clock Configuration   
#define UART2_DR                (*((volatile uint32_t *) 0x4000C000)) // UART Data   
#define UART2_FR                (*((volatile uint32_t *) 0x4000C018)) // UART Flag  
